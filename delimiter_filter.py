...
output_VC_lexicon = open("edilex3_VC.csv", "w")
output_VC_html_ready = open("edilex3_VC", "w")
output_CVC_lexicon = open("edilex3_CVC.csv", "w")
output_CVC_html_ready = open("edilex3_CVC", "w")
output_CCVC_lexicon = open("edilex3_CCVC.csv", "w")
output_CCVC_html_ready = open("edilex3_CCVC", "w")
output_CCCVC_lexicon = open("edilex3_CCCVC.csv", "w")
output_CCCVC_html_ready = open("edilex3_CCCVC", "w")
